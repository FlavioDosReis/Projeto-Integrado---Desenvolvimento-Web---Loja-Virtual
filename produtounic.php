...
<html lang="pt_br">
  ...
  <body>
    ...
    <section class="header__top">
      <div class="header__top__desktop max__width">
        <div class="header__top__left">
          <a class="icon__header">
        ...
        <div class="header__top__right">
          <div class="icon__header">
            ...
            <img src=".//assets/images/ui/phone-line.png" alt="telefone" />
    ...
    <header>
      <div class="header__main max__width">
        ...
        <div class="header__right">
          ...
          <!-- Menu - Mobile -->
          <a class="btn__icon menu__burger">
            <img src=".//assets/images/ui/menu-line.png" alt="menu" />
          </a>
        </div>
      </div>
    ...
    <main class="max__width">
      <section class="breadcrub">Início > Lista de Produtos > Produto</section>

      <section class="produto__unic">
        <div class="imagem__principal">
          <img src="" alt="" />
        </div>
        <div class="imagem__info">
          <div class="codigo">CÓD:</div>
          <div class="name"></div>
          <div class="price__from">de <span></span> por</div>
          <div class="price__to"></div>
          <div class="payments">Pagamento via PIX</div>
          <div class="buttons">
            <button>Comprar</button>
            <button>Adicionar ao carrinho</button>
          </div>
          <div class="shipping">
            <div>Calcular frete:</div>
      ...
      <section class="description">
        <div class="description__title">Informações do produto</div>
    ...
    <footer>
      <div id="footer" class="footer__container max__width">
          ...
          <div class="social">
            ...
            <div class="social__icones">
              <a class="btn__icon" href="">
                <img
                  src="./assets/images/ui/facebook-line.png"
                  alt="facebook"
                />
              </a>
              <a class="btn__icon" href="">
    ...
    <script type="text/javascript" src="./scripts/js/produtounic.js"></script>
